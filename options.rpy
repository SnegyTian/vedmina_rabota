...
define config.name = _("Ведьмина работа")
...
define gui.about = _p("""
Автор игры - Snegy tian\n
Художник и саунд-дизайнер - Just Krestik\n
Музыка взята с сайта - https://w84.megasongs.me/piano\n
Мы очень старались над данным проектом. В дальнейшем будем его улучшать и совершенствовать.\n 
Огромное спасибо за поддержку и помощь Ризвановой Айгуль Фагидовне, Семёнову Глебу, прекрасной художнице Сокольниковой Кристине и её велеколепному ноуту, и хорошему интернету. \n
""")
...
define build.name = "Vedmina_rabotaDemo"
...
define config.sample_sound = "audio/zakrdver.mp3"
...
define config.main_menu_music = "audio/menushka.mp3"
...
define config.save_directory = "Vedmina_rabota2_0-1712495608"
