...
define gui.accent_color = '#5D93A5'



define gui.idle_color = '#6cd1eb'
...
define gui.hover_color = '#b6d8e0'





define gui.selected_color = '#9feafc'



define gui.insensitive_color = '#8e9fa3'
